# AI for IT Services & Software Firms — `/en/industries/ai-for-it-services`
...
**Page type (§9):** Service / sector landing (IT services) — MOFU
...
|---|---|
| HTTP status | 200 |
| Title (rendered, incl. `\| AI Makers`) | `AI for IT Services & Software Firms \| AI Makers` — **47** chars |
| Meta description | **147** — in budget |
| `<h1>` count | 1 |
| `<h2>` / `<h3>` | 8 / 15 |
| Body words (header/footer stripped) | 818 |
| JSON-LD emitted | `BreadcrumbList`, `FAQPage` |
| hreflang | reciprocal fr/en/x-default ✅ |
| In `sitemap.xml` | yes ✅ |
| Canonical | `https://aimakers.fr/en/industries/ai-for-it-services` ✅ |
...
🟡 **"ESN" has no English search equivalent**, which the master states plainly: the closest EN intents ("ai for software development" 400/mo US, "ai for it services" 20/mo) are a thin cluster. Honest framing, but this page targets a French-market ICP in English and should not be expected to earn EN traffic.

## What this page gets right

- **Sector-native differentiation.** The named-tool specificity (Claude Code, Cursor, Codex) is first-hand detail rather than category language, and the "without pulling anyone off billable delivery" objection-handler answers the actual buying objection of a services firm.
...
- **818 words** of substantive body copy, comfortably clear of thin.
