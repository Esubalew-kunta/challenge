# Data Engineer — role page — `/en/careers/data-engineer`
...
|---|---|
| HTTP status | 200 |
| Title (rendered, incl. auto-appended brand) | `Data Engineer: AI Makers Careers \| AI Makers` — **44** chars ✅ |
| Meta description | **129** — under the 140 floor 🟡 |
| `<h1>` | 1 — `Data Engineer : The foundation everything else rests on` |
| `<h2>` / `<h3>` | 5 / 13 |
| Body words (header/footer stripped) | 589 |
| JSON-LD emitted (verified in rendered HTML) | `BreadcrumbList`, `JobPosting` |
| hreflang | reciprocal fr/en/x-default ✅ |
| In `sitemap.xml` | yes ✅ |
| Canonical | `https://aimakers.fr/en/careers/data-engineer` ✅ |
...
🟡 **Meta description is 129 chars, 11 under the 140 floor.** There is unused width here — add the differentiator or the next step rather than leaving it short.
...
- **Title 44 chars** including the auto-appended brand — inside budget, and free of the double-suffix defect that affects the parent hub.
- **589 words**: substantive for a role page, not a pasted job spec.
