# AI Engineer — role page — `/en/careers/ai-engineer`
...
|---|---|
| HTTP status | 200 |
| Title (rendered, incl. auto-appended brand) | `AI Engineer: AI Makers Careers \| AI Makers` — **42** chars ✅ |
| Meta description | **130** — under the 140 floor 🟡 |
| `<h1>` | 1 — `AI Engineer : You build it, it ships to production` |
| `<h2>` / `<h3>` | 5 / 13 |
| Body words (header/footer stripped) | 623 |
| JSON-LD emitted (verified in rendered HTML) | `BreadcrumbList`, `JobPosting` |
| hreflang | reciprocal fr/en/x-default ✅ |
| In `sitemap.xml` | yes ✅ |
| Canonical | `https://aimakers.fr/en/careers/ai-engineer` ✅ |
...
🟡 **Meta description is 130 chars, 10 under the 140 floor.** There is unused width here — add the differentiator or the next step rather than leaving it short.
...
- **623 words**: substantive for a role page, not a pasted job spec.
