# AI for Market Research & Consulting — `/en/industries/ai-for-market-research`
...
**Page type (§9):** Service / sector landing (consulting) — MOFU
...
|---|---|
| HTTP status | 200 |
| Title (rendered, incl. `\| AI Makers`) | `AI for Market Research & Consulting \| AI Makers` — **47** chars |
| Meta description | **149** — in budget |
| `<h1>` count | 1 |
| `<h2>` / `<h3>` | 8 / 15 |
| Body words (header/footer stripped) | 708 |
| JSON-LD emitted | `BreadcrumbList`, `FAQPage` |
| hreflang | reciprocal fr/en/x-default ✅ |
| In `sitemap.xml` | yes ✅ |
| Canonical | `https://aimakers.fr/en/industries/ai-for-market-research` ✅ |
...
🟡 **Thinnest sector page at 708 words** against a collection running 699–818 and siblings at 800+. Not thin in absolute terms and it matches intent, but it has the least depth of the eight.

## What this page gets right

- **Sector-native differentiation.** Deep-vertical use cases (verbatim coding, knowledge capitalisation) that no sibling page repeats, and the "sources kept traceable" / "reviewed by consultants" qualifiers keep the automation claims honest.
...
- **708 words** of substantive body copy, comfortably clear of thin.
