...
export const TRACKS = [
{
  ...
  beginner: [
    { p: 1, q: "Le GEO (Generative Engine Optimization), c'est :",
      o: ["Optimiser la visibilité d'une marque dans les réponses des moteurs génératifs", "Optimiser la présence d'une entreprise dans les résultats de recherche locale", "Rattacher une marque à une base d'entités partagée entre les moteurs", "Structurer les données d'un site pour faciliter leur extraction par les robots"],
    ...
    { p: 1, q: "La « citabilité » d'un contenu désigne :",
      o: ["Sa capacité à être repris comme source par un moteur d'IA", "Sa capacité à être partagé et commenté sur les réseaux sociaux", "Sa conformité au droit de citation et à la propriété intellectuelle", "Le nombre de sites qui pointent vers lui avec un lien suivi"],
    ...
    { p: 1, q: "Les AI Overviews de Google apparaissent :",
      o: ["En haut des résultats, sous forme de réponse générée avec ses sources", "En bas des résultats, sous forme de suggestions de questions liées", "Uniquement sur mobile, dans l'application Google et pas sur ordinateur", "Uniquement sur les requêtes commerciales, à la place des annonces"],
    ...
    { p: 2, q: "Un acheteur pose sa question à Perplexity, lit la réponse et ne clique sur aucune source. Pour votre reporting, c'est :",
      o: ["Une recherche sans clic : vous avez peut-être été cité sans recevoir de visite", "Un rebond : la visite a eu lieu mais s'est arrêtée à la première page", "Une conversion douce : l'acheteur a retenu votre nom sans agir", "Une impression perdue : votre page a été affichée sans être lue"],
    ...
    { p: 2, q: "Dans un outil de suivi de visibilité IA, la « part de voix » de votre marque mesure :",
      o: ["La fréquence d'apparition de votre marque sur un jeu de questions suivies, face aux concurrents", "La part de votre trafic organique rapportée à votre trafic payant sur la période", "Le pourcentage de vos pages indexées par les moteurs génératifs, rapporté au total des pages publiées sur le site", "Votre nombre de liens entrants rapporté à celui de vos concurrents directs"],
    ...
    { p: 3, q: "Vous voulez que les assistants citent vos tarifs sans se tromper. La première chose à faire :",
      o: ["Écrire les prix en texte sur la page, pas seulement dans une image ou un composant chargé après coup", "Ajouter des liens internes depuis les pages les plus visitées vers la page des tarifs", "Allonger la page des tarifs avec une description détaillée de chaque formule", "Acheter des annonces sur le nom de votre marque pour que les tarifs remontent en premier"],
  ...
  intermediate: [
    { p: 1, q: "Vos positions ne bougent pas, vos impressions montent de 30 %, vos clics baissent de 18 %. L'explication la plus probable :",
      o: ["Vos résultats sont absorbés par des réponses générées qui répondent sans clic", "Une partie de votre site a été désindexée à la suite d'une mise à jour", "Un changement de balise titre a fait chuter votre taux de clic", "Un concurrent a surenchéri en publicité sur vos requêtes principales"],
    ...
    { p: 2, q: "Votre usine à contenu sort vingt articles par semaine, rédigés par un agent. Le risque principal pour votre visibilité dans les réponses IA :",
      o: ["Vingt pages qui n'apportent aucune information qu'un modèle n'a pas déjà : rien à citer", "Vingt pages de plus que ce que Google accepte d'indexer pour un site de cette taille", "Vingt pages trop lourdes, qui se chargent lentement et pénalisent tout le domaine", "Vingt pages où la densité de mots-clés devient trop élevée pour rester naturelle"],
    ...
    { p: 3, q: "Votre agent de contenu publie le même article sur trois surfaces (votre blog, une page média, un espace partenaire). Le risque principal :",
      o: ["Aucune version n'est désignée comme canonique, et le modèle ne sait pas laquelle citer", "Le temps de chargement augmente sur les trois sites, faute de cache partagé", "Les trois surfaces se partagent le même budget publicitaire et se cannibalisent", "Les liens internes deviennent inutiles, parce que le contenu vit ailleurs"],
    ...
    { p: 3, q: "Un concurrent est bien plus cité que vous sur le même sujet. Votre premier réflexe de diagnostic :",
      o: ["Vérifier que vos pages sont réellement accessibles et rendues en texte, avant de toucher au contenu", "Réécrire l'ensemble de votre contenu sur un ton plus conversationnel, proche des questions posées", "Doubler le rythme de publication pour occuper davantage de requêtes sur le sujet", "Obtenir des liens depuis les pages concurrentes les plus citées, par partenariat"],
    ...
    { p: 3, q: "Un outil vous indique que votre marque est mentionnée dans 12 % des réponses de votre catégorie. Ce chiffre seul vous apprend :",
      o: ["Presque rien, tant qu'on ne sait pas quelles questions, quels modèles et quelle zone ont été suivis", "Qu'il vous manque 88 % de contenu pour couvrir l'ensemble des questions de la catégorie", "Que votre référencement classique est en échec et qu'il tire la visibilité IA vers le bas", "Que vos concurrents disposent de meilleurs liens entrants et d'une autorité supérieure"],
  ...
  expert: [
    { p: 1, q: "Trois de vos pages avancent le même argument avec des chiffres légèrement différents. Les assistants citent systématiquement un concurrent. Cause la plus probable :",
      o: ["Votre corpus se contredit lui-même, ce qui vous rend moins fiable qu'un concurrent cohérent", "Vous avez trop peu de pages sur le sujet pour peser face à un concurrent plus prolifique", "Votre autorité de domaine est trop faible pour qu'un modèle vous retienne comme source", "Le concurrent est davantage partagé sur les réseaux, ce que les modèles prennent en compte"],
    ...
    { p: 3, q: "Le trafic venu des IA arrive souvent sans référent exploitable. La façon la plus fiable de le mesurer :",
      o: ["Croiser l'analyse des agents dans les journaux serveur et un suivi de citations, en gardant deux mesures distinctes", "Se fier au regroupement de canaux de votre outil d'analyse, qui isole désormais le trafic venu des IA", "Demander aux nouveaux clients, dans un formulaire, par quel assistant ils vous ont découvert", "Le supposer proportionnel au trafic organique et l'estimer à partir de la part de marché des assistants"],
    ...
    { p: 3, q: "Vous rejouez 200 questions par semaine sur quatre modèles pour suivre vos mentions. Le défaut le plus susceptible de fausser votre courbe :",
      o: ["La dérive des versions de modèles et une température non nulle, qui font passer du bruit pour une évolution", "Le fait de lancer le suivi à intervalle fixe plutôt qu'à la demande, ce qui lisse les variations", "Le fait de suivre trop de concurrents à la fois, ce qui dilue la part de voix de chacun", "Le fait de stocker les résultats en base plutôt que dans l'outil, ce qui fausse les comparaisons"],
    ...
    { p: 3, q: "Les AI Overviews décomposent une requête en plusieurs sous-requêtes. Conséquence pratique pour la conception du contenu :",
      o: ["Couvrir sérieusement les questions voisines augmente vos chances d'être récupéré", "Viser uniquement des expressions longues en correspondance exacte devient indispensable", "La vitesse de chargement compte désormais plus que la profondeur du contenu", "Il faut une page distincte par variante de mot-clé pour répondre à chaque sous-requête"],
...
},
{
  ...
  beginner: [
    { p: 1, q: "Un agent IA, au sens où on le met en production, c'est :",
      o: ["Un système qui utilise un modèle de langage pour accomplir une tâche de bout en bout, en boucle : décider, agir, observer", "Un modèle de langage plus gros qu'un chatbot, entraîné sur les données de l'entreprise pour répondre plus juste", "Une interface de discussion branchée sur une API de modèle, avec un historique et un prompt système", "Un script qui appelle un modèle une fois par ligne d'un fichier et enregistre chaque réponse"],
    ...
    { p: 1, q: "La fenêtre de contexte d'un modèle, c'est :",
      o: ["La quantité maximale de texte, en tokens, que le modèle peut prendre en compte dans un même échange", "Le délai maximal, mesuré en secondes, avant qu'une requête au modèle soit annulée par l'API et facturée quand même", "Le nombre maximal d'outils qu'un modèle peut appeler au cours d'une même conversation", "Le nombre maximal d'utilisateurs simultanés autorisés sur un même compte d'API"],
    ...
    { p: 1, q: "Une hallucination, c'est :",
      o: ["Une réponse fausse mais formulée avec assurance : fait inventé, source inexistante, chiffre erroné", "Une réponse trop longue, qui déborde de la question posée et ajoute du contenu non demandé", "Une réponse qui refuse de traiter la demande au motif qu'elle sort du cadre autorisé", "Un bug d'affichage de l'interface, où la réponse apparaît tronquée ou mal encodée"],
    ...
    { p: 2, q: "À quoi sert le protocole MCP (Model Context Protocol) ?",
      o: ["Standardiser la connexion entre un modèle d'IA et des ressources externes : outils, données, applications", "Compresser les prompts pour qu'ils tiennent dans la fenêtre de contexte sans perdre d'information", "Chiffrer les échanges entre un client et une API de modèle, de bout en bout", "Convertir les poids d'un modèle d'un format à un autre pour changer de fournisseur"],
    ...
    { p: 2, q: "Un appel d'outil (function call) signifie :",
      o: ["Le modèle renvoie une demande structurée d'exécution ; votre code l'exécute et lui renvoie le résultat", "Le modèle exécute directement du code sur votre serveur, dans un environnement isolé prévu à cet effet par le fournisseur", "Le modèle ouvre lui-même une connexion réseau vers l'API externe et lit la réponse", "Le modèle se réentraîne sur la fonction pour apprendre à l'appeler correctement"],
    ...
    { p: 2, q: "Le RAG (génération augmentée par récupération) consiste à :",
      o: ["Connecter le modèle aux données internes : les documents pertinents sont récupérés à chaque question et placés dans le prompt", "Réentraîner partiellement le modèle sur vos documents pour qu'il en retienne le contenu dans ses poids et réponde sans les relire", "Mettre en cache les réponses les plus fréquentes pour réduire le coût et la latence des appels", "Faire répondre deux modèles à la même question et ne garder que la réponse commune"],
    ...
    { p: 3, q: "Pourquoi une équipe fige-t-elle une version précise de modèle en production ?",
      o: ["Pour que le comportement et les évaluations restent stables quand le fournisseur change son modèle par défaut", "Pour obtenir un tarif réduit, les fournisseurs facturant moins cher les versions anciennes", "Parce qu'un modèle non figé cesse de répondre dès que le fournisseur publie une version plus récente et retire l'ancienne", "Pour bénéficier d'une fenêtre de contexte plus grande, réservée aux versions épinglées"],
  ...
  intermediate: [
    { p: 1, q: "Votre agent appelle le même outil, avec les mêmes arguments, sans jamais s'arrêter. Première chose à vérifier :",
      o: ["Que le résultat de l'outil revient bien dans la conversation, sous une forme exploitable", "Que le modèle est assez grand pour la tâche, et passer à la version supérieure sinon", "Que la température n'est pas trop basse, ce qui bloquerait le modèle sur le même choix", "Que la fenêtre de contexte n'est pas pleine, ce qui empêcherait de lire le résultat"],
    ...
    { p: 1, q: "La qualité la plus importante d'une description d'outil :",
      o: ["Dire précisément quand l'utiliser et ce que signifient ses arguments, dans les termes du modèle", "Rester courte, pour économiser des tokens à chaque tour où la liste complète des outils est renvoyée au modèle", "Reprendre exactement le nom de votre fonction interne, pour éviter toute confusion", "Préciser le langage d'implémentation et la signature technique de la fonction"],
    ...
    { p: 1, q: "Un copilote métier (assistant intégré aux outils d'un service) et un agent autonome diffèrent surtout par :",
      o: ["Qui garde la main : le copilote propose et l'humain valide chaque action ; l'agent enchaîne seul", "Le modèle utilisé : le copilote tourne sur un petit modèle, l'agent sur le plus capable", "Le coût par token : le copilote est facturé à l'usage, l'agent au forfait mensuel", "La fenêtre de contexte : le copilote lit un document, l'agent lit toute la base"],
    ...
    { p: 2, q: "Vous avez besoin qu'un agent produise une sortie qui respecte réellement une structure JSON. L'approche la plus robuste :",
      o: ["L'imposer au niveau de l'appel d'outil avec un schéma : une réponse non conforme est rejetée et rejouée", "Demander du JSON dans le prompt, avec un exemple, et parser la réponse en tolérant les écarts", "Nettoyer le texte de la réponse avec une expression régulière avant de le parser", "Mettre la température à zéro pour que le modèle produise toujours la même structure"],
    ...
    { p: 2, q: "Un bon jeu de référence pour évaluer un agent doit :",
      o: ["Contenir des cas au résultat connu, y compris les pannes réellement rencontrées en production", "Ne contenir que les cas les plus tordus qu'on puisse inventer, pour éprouver l'agent", "Être régénéré par un modèle à chaque exécution, pour éviter que l'agent l'apprenne par cœur", "Être le plus gros possible, quitte à laisser un modèle produire les étiquettes"],
    ...
    { p: 3, q: "Le contenu renvoyé par un outil contient la phrase « ignore tes instructions précédentes ». C'est :",
      o: ["Une injection de prompt indirecte : le harnais doit traiter tout résultat d'outil comme une donnée non fiable", "Un bug du modèle à signaler au fournisseur, qui corrigera dans la version suivante", "Sans effet, puisque le prompt système est prioritaire sur tout contenu ultérieur", "Impossible dès lors qu'on passe par MCP, le protocole filtrant ce type de contenu avant qu'il n'atteigne le modèle"],
  ...
  expert: [
    { p: 1, q: "Un agent avec accès au terminal doit libérer de l'espace disque ; il supprime un dossier dont l'utilisateur avait besoin. Le défaut de conception :",
      o: ["Une action irréversible a été exécutée sans confirmation ni aperçu de ce qui allait être supprimé", "Le modèle n'était pas assez capable pour distinguer un dossier utile d'un dossier temporaire", "La consigne était trop vague et aurait dû nommer les dossiers autorisés à la suppression", "La description de l'outil était trop longue et le modèle en a ignoré les avertissements"],
    ...
    { p: 1, q: "Vous devez déboguer une exécution d'agent qui a échoué il y a trois jours. La propriété qui rend ça possible :",
      o: ["Une trace de chaque prompt, appel d'outil et résultat, rejouable sur une version de modèle figée", "Des journaux applicatifs verbeux, avec le niveau de détail maximal activé en production sur toute la période", "Une durée de rétention des journaux assez longue pour couvrir la période concernée", "La sauvegarde de la sortie finale et du message d'erreur de chaque exécution"],
    ...
    { p: 1, q: "Vous ajoutez une étape de relecture (« critique ta réponse, puis corrige-la »). L'arbitrage réel :",
      o: ["Latence et coût multipliés, pour un gain réel sur certaines tâches et quasi nul sur d'autres", "Une amélioration garantie de la justesse, quelle que soit la tâche, au prix d'un peu de latence", "Une baisse de la consommation de tokens, les réponses corrigées étant plus courtes", "La disparition des hallucinations, le modèle vérifiant lui-même ses affirmations"],
    ...
    { p: 2, q: "Une fenêtre de 200 000 tokens est remplie à 180 000 et la qualité se dégrade sur les détails du milieu. La meilleure parade :",
      o: ["Ne récupérer que ce qui est pertinent et le placer près de la fin, plutôt que de tout empiler", "Augmenter la température pour encourager le modèle à explorer l'ensemble du contexte", "Passer à un modèle à fenêtre plus grande, pour que le milieu ne soit plus au milieu", "Répéter le prompt système à la fin du contexte pour rappeler les consignes"],
    ...
    { p: 2, q: "Deux agents écrivent dans le même fichier en parallèle et une modification disparaît sans bruit. La bonne correction :",
      o: ["Isoler l'espace de travail de chaque agent, copies ou branches séparées, et fusionner explicitement", "Écrire dans le prompt de chaque agent la liste des fichiers que l'autre est en train de modifier", "Les faire tourner à température zéro pour que leurs modifications soient prévisibles", "Faire relire le travail de l'un par l'autre après coup, pour repérer ce qui a disparu"],
    ...
    { p: 2, q: "Un Forward Deployed Engineer arrive chez un client pour brancher un agent sur l'ERP. Sa première livraison, avant toute ligne d'agent :",
      o: ["Un accès en lecture seule, un jeu de cas réels étiquetés et une trace d'exécution : de quoi mesurer avant de changer", "Le prompt système de l'agent, validé par le client, pour cadrer le périmètre avant tout développement", "Un tableau de bord de suivi des tokens, pour que le client voie le coût dès le premier jour", "Une démonstration sur des données fictives, pour obtenir l'accord du comité avant l'accès réel"],
    ...
    { p: 3, q: "Vous ajoutez une définition d'outil en cours de conversation, sur un prompt mis en cache. Effet :",
      o: ["Tout ce qui suit le point d'insertion est invalidé : une liste d'outils qui change tard coûte le cache", "Aucun : les définitions d'outils sont mises en cache séparément du reste du prompt", "Tout le cache saute, prompt système compris, et la requête suivante repart de zéro comme au premier appel de la session", "Le modèle ignore le nouvel outil jusqu'à ce que le cache expire de lui-même"],
    ...
    { p: 3, q: "Le risque principal d'un modèle utilisé comme juge dans votre chaîne d'évaluation :",
      o: ["Un biais systématique, vers la longueur, vers son propre style, vers la première option, corrélé à votre indicateur", "Une lenteur qui le rend inutilisable dans l'intégration continue, où chaque test doit tourner en secondes", "Une incapacité à produire des chiffres stables, le modèle ne sachant noter qu'en texte libre", "Un besoin de réentraînement du juge à chaque nouvelle version du modèle évalué, sans quoi ses notes ne sont plus comparables"],
